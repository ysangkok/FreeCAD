...
void TaskLinkDim::onCurrentItemChanged(QTreeWidgetItem* current, QTreeWidgetItem* previous)
{
    ...
    Q_UNUSED(previous);
//    if (previous) {
//        printf("TRACE - TLD::onCurrent - text: %s data: %s is previous\n",
...
//            printf("TRACE - TLD::onCurrent - previous belongs to selected\n");
//        }
//        if (previous->treeWidget() == ui->selector->availableTreeWidget()) {
//            printf("TRACE - TLD::onCurrent - previous belongs to available\n");
//        }
//    }
//    if (current) {
//        printf("TRACE - TLD::onCurrent - text: %s data: %s is current\n",
...
//            printf("TRACE - TLD::onCurrent - current belongs to selected\n");
//        }
//        if (current->treeWidget() == ui->selector->availableTreeWidget()) {
//            printf("TRACE - TLD::onCurrent - current belongs to available\n");
//        }
//    }
}
